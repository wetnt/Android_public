...
public class BBKScreen {
	...
	public static void BBKActivitySet(Activity act) {
		// --------------------全屏运行--------------------------------
		...
		// --------------屏蔽Home按键--------------------------------------
		// act.getWindow().setFlags(FLAG_HOMEKEY_DISPATCHED,
		// FLAG_HOMEKEY_DISPATCHED);
		// --------------隐去标题栏--------------------------------------
	}

	public static void BBKActivityMenu(Activity act) {
		// --------------强制显示Menu虚拟按键----------------------------
		...
		act.getWindow().setFlags(0x08000000, 0x08000000);// 强制显示Menu虚拟按键！
		// --------------强制显示Menu虚拟按键----------------------------
	}
