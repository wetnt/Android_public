...
public class BBKShape {
	...
	public static double ReadDouble(int type) {
		...
		if (type == 1) {// 1双精度大 0双精度小
			// ----------------------------------------------------
			reg = ((long) buffer[poi + 0] << 56) + ((long) (buffer[poi + 1] & 255) << 48)
					+ ((long) (buffer[poi + 2] & 255) << 40) + ((long) (buffer[poi + 3] & 255) << 32)
					+ ((long) (buffer[poi + 4] & 255) << 24) + ((buffer[poi + 5] & 255) << 16)
					+ ((buffer[poi + 6] & 255) << 8) + ((buffer[poi + 7] & 255) << 0);
			// ----------------------------------------------------
		} else {
			// ----------------------------------------------------
			reg = ((long) buffer[poi + 7] << 56) + ((long) (buffer[poi + 6] & 255) << 48)
					+ ((long) (buffer[poi + 5] & 255) << 40) + ((long) (buffer[poi + 4] & 255) << 32)
					+ ((long) (buffer[poi + 3] & 255) << 24) + ((buffer[poi + 2] & 255) << 16)
					+ ((buffer[poi + 1] & 255) << 8) + ((buffer[poi + 0] & 255) << 0);
			// ----------------------------------------------------
		}
		// --------------------------------------------------------
		bufposition += 8;
	...
	public static int ReadInt32(int type) {
		...
		if (type == 1) {// 1整数大 0整数小
			// --------------------------------------------------------
			reg = ((buffer[poi + 0] & 255) << 24) + ((buffer[poi + 1] & 255) << 16) + ((buffer[poi + 2] & 255) << 8)
					+ ((buffer[poi + 3] & 255) << 0);
			// --------------------------------------------------------
		} else {
			// --------------------------------------------------------
			reg = ((buffer[poi + 3] & 255) << 24) + ((buffer[poi + 2] & 255) << 16) + ((buffer[poi + 1] & 255) << 8)
					+ ((buffer[poi + 0] & 255) << 0);
			// --------------------------------------------------------
		}
		// --------------------------------------------------------
