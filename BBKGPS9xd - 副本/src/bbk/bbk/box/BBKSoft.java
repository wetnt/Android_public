...
public class BBKSoft  extends Service {
	...
	// ####################################################################################
	// ====================================================================================
	public static void BBKScreenOrientRun(int ScreenOrient, int w, int h) {
		// ----------------------------------------------------
		myBoxs.LayReInt();
	...
	public void BBKSoftPathSet() {
		// ----------------------------------------------------
		PathSD = BBKSdCard2.getLastSdCardPath();
		String[] pa = BBKSdCard2.GetAllSdPath();
		BBKSavePathSelect.GetRunCount((Activity) bbkContext, pa);
		// ----------------------------------------------------
		if (PathSD == "")
			PathSD = BBKSdCard2.getSDCardPath();// 手机内置SDcard
		if (PathSD == "")
