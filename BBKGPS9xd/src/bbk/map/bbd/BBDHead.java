...
public class BBDHead {
	...
	public static final String mappicsurls[] = { "/lyrs=m@" + MapVs + "&hl=zh-CN&s=Ga&",
			"/lyrs=s@" + SatVs + "&s=Gali&", "/lyrs=t@" + MapVs + ",r@" + MapVs + "&hl=zh-CN&s=G&",
			"/imgtp=png32&lyrs=h@" + MapVs + "&hl=zh-CN&s=G&",
			"?hl=zh-CN&lyrs=m@" + MapVs + ",traffic|seconds_into_week:-1&" };
	// =====================================================================================
