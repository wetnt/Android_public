...
import com.boboking.joysticks.MainActivity;
...
public class BBKBlueTooth {
	...
	private String DevAddress = "00:BA:55:57:5B:15";
	// ========================================================================
	...
	private Handler mHandler = new Handler() {// 消息处理器..日理万鸡的赶脚...
		...
		public void handleMessage(Message msg) {
			...
			case CONNECT_FAIL:
				d.s("连接失败");
				MainActivity.BlueTooth_OnOffline_Set(false);
				break;
			...
			case CONNECT_SUCCEED_N:
				...
				if (msg.what == CONNECT_SUCCEED_P) {
					...
					d.s("连接成功" + stateStr);
					MainActivity.BlueTooth_OnOffline_Set(true);
				} else {
					if (connectThread != null) {
						connectThread.interrupt();
					}
