...
public class BBK_Tool_Screen {
	...
	// ========================================================================
	// 获取标题栏的高度
	public static int get_Title_Height(Activity activity) {
		Rect rect = new Rect();
	...
	// 获取状态栏高度
	public static int get_State_Height(Activity activity) {
		Rect rect = new Rect();
		activity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
		return rect.top;
	}

	public static int screenWidth, screenHeight;// 获取屏幕宽高

	public static int[] get_Screen_Width_Height_InPx(Activity activity) {
